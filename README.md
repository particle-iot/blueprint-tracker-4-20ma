# blueprint-tracker-4-20ma

This tutorial includes hardware and software for connecting a single 4-20mA current loop sensor to the Tracker One using the M8 connector.
...
![Single Board](images/single-board.png)
